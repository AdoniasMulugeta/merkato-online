...
if(Input::exists('search','GET')){
    if(Input::exists('search_field','GET') && !empty(Input::get('search_field', 'GET'))){
        ...
        header("Location: productDetail.php?name={$name}");
    }
}
?>
<!DOCTYPE>
...
<body>
	<div id="main-area">
		<section id="header">
			...
			<aside class="top-nav">
				<ul>
				    <li><a href="<?=ACCOUNT_PAGE?>"><img src="images/product-catagory/person1.png"> Your Profile</a></li>
					<li><a href="<?=ORDER_PAGE?>">Orders</a></li>
					<li><a href="<?=CART_PAGE?>"><img src="images/product-catagory/whiteChart.png" width="19" height="19"> Cart</a></li>
					<li><a href="<?=WISH_LIST_PAGE?>">Wish List</a></li>
			...
			<aside class="credentials">
				<ul>
					<?php if(!Session::exists('user_id')):?>
							...
							<li><a id="login" href="<?=SIGNIN_PAGE?>">Login</a></li>
					<?php else:?>
			...
			<div id="depa-dropdown">
				<span><a href="#">Departments </a></span>
					<div id="depa-dropdown-content">
	 					<ul>
		                <a href="productDetail.php?catagory=Laptop"><li>Laptop</li></a>
						<a href="productDetail.php?catagory=desktop"><li>Desktop</li></a>
