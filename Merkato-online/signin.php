...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="<?=CSS_DIR?>/signin.css">
	<title>SIGN IN MERKATO ONLINE</title>
</head>
<body>
	<a href="<?=HOME_PAGE?>"><img src="<?=IMAGE_DIR?>/signin/logoRed.png"></a>
	<section>
		<h2>Sign in</h2>
		<form action="#" method="POST">
			...
			<p id="have-acc">
                            New to merkatoOnLine? &nbsp; <a href="<?=SIGNUP_PAGE?>">Sign up</a>
			</p>
		</form>
	</section>
	<div id="footer">
